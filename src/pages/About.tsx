    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-blue-50">
      ...
      <div className="pt-20 pb-16 px-4">
        <div className="container mx-auto">
          ...
          {/* Key Features */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800 animate-fade-in">Why Choose CreditAI?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="text-center hover:shadow-lg transition-shadow hover-lift animate-scale-in">
                <CardHeader>
                  ...
                  <CardTitle className="text-gray-800">AI-Powered Intelligence</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow hover-lift animate-scale-in" style={{ animationDelay: '0.2s' }}>
                <CardHeader>
                  ...
                  <CardTitle className="text-gray-800">Bank-Grade Security</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow hover-lift animate-scale-in" style={{ animationDelay: '0.4s' }}>
                <CardHeader>
                  ...
                  <CardTitle className="text-gray-800">Proven Results</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
