    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-blue-50">
      ...
      <div className="pt-20 pb-16 px-4">
        <div className="container mx-auto">
          ...
          {/* Key Features */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-center mb-12 text-slate-800 animate-fade-in">Why Choose CreditAI?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="text-center hover:shadow-lg transition-shadow hover-lift animate-scale-in">
                <CardHeader>
                  ...
                  <CardTitle className="text-slate-800">AI-Powered Intelligence</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow hover-lift animate-scale-in" style={{ animationDelay: '0.2s' }}>
                <CardHeader>
                  ...
                  <CardTitle className="text-slate-800">Bank-Grade Security</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-slate-600">
              ...
              <Card className="text-center hover:shadow-lg transition-shadow hover-lift animate-scale-in" style={{ animationDelay: '0.4s' }}>
                <CardHeader>
                  ...
                  <CardTitle className="text-slate-800">Proven Results</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-slate-600">
          ...
          <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-8 mb-16 animate-fade-in">
            <h2 className="text-3xl font-bold text-center mb-12 text-slate-800">Our Impact</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div className="animate-bounce-custom">
                <div className="text-4xl font-bold text-orange-600 mb-2">1M+</div>
                <div className="text-slate-600">Credit Scores Generated</div>
              </div>
          ...
          <div className="text-center animate-fade-in">
            <h2 className="text-3xl font-bold mb-8 text-slate-800">Our Team</h2>
            <p className="text-xl text-slate-700 max-w-3xl mx-auto">
