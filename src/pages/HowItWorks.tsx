    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-blue-50">
      ...
      <div className="pt-20 pb-16 px-4">
        <div className="container mx-auto">
          ...
          {/* Process Steps */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-center mb-12">The CreditAI Process</h2>
                ...
                <div key={index} className="relative">
                  <Card className="h-full hover:shadow-lg transition-shadow">
                    <CardHeader className="text-center">
                      ...
                      <div className="text-lg font-bold text-gray-400 mb-2">Step {index + 1}</div>
          ...
          <div className="mb-16">
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8">
              <h2 className="text-3xl font-bold text-center mb-8">Alternative Data Points We Analyze</h2>
